...
var MobileMenu = function () {
  ...
  _createClass(MobileMenu, [{
    key: 'events',
    value: function events() {
      (0, _jquery2.default)('.site-nav__menu-toggle').click(function () {

        (0, _jquery2.default)('.site-nav').toggleClass('site-nav--open', 500);
...
var LoginTab = function () {
  function LoginTab() {
    ...
    this.modalTab = (0, _jquery2.default)(".modal__tab-content");
    this.modalTabLink = (0, _jquery2.default)(".modal__tab-nav, .modal__signin");
    this.events();
  }
